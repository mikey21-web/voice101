...
export default function VoiceCallLogsPage() {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div>
        <h1 className="text-3xl font-bold text-[var(--foreground)]">Call Logs</h1>
        <p className="text-sm text-[var(--muted-foreground)] mt-2">All calls the voice agent has made across campaigns and languages</p>
      </div>
