...
export default function VoiceInstantLeadsPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div>
        <h1 className="text-xl font-bold text-[var(--foreground)]">Instant Leads</h1>
        <p className="text-sm text-[var(--muted-foreground)] mt-0.5">Call one number right now with a published employee</p>
      </div>
