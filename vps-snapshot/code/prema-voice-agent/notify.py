...
def notify_booking_confirmed(
    ...
    try:
        ...
        # Cross-platform: %-I is Linux-only, %#I is Windows-only
        hour = dt.strftime("%I").lstrip("0") or "12"
        readable = dt.strftime(f"%A, %d %B %Y at {hour}:%M %p IST")
    except Exception:
    ...
    message = (
        ...
        f"━━━━━━━━━━━━━━━━━━━━━━\n"
        + (f"💬 *AI Summary:*\n_{ai_summary}_\n\n" if ai_summary else "")
        + f"_Booked via ClickProps AI Voice Agent_ 🤖"
    )
