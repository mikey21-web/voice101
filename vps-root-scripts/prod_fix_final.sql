...
-- AlterTable (safe rename, subscriptions has 0 rows in production but rename avoids any risk)
ALTER TABLE "subscriptions" RENAME COLUMN "canceled_at" TO "canceledAt";
ALTER TABLE "subscriptions" RENAME COLUMN "created_at" TO "createdAt";
ALTER TABLE "subscriptions" RENAME COLUMN "current_period_end" TO "currentPeriodEnd";
...
ALTER TABLE "subscriptions" RENAME COLUMN "stripe_customer_id" TO "stripeCustomerId";
ALTER TABLE "subscriptions" RENAME COLUMN "stripe_subscription_id" TO "stripeSubscriptionId";
ALTER TABLE "subscriptions" RENAME COLUMN "trial_ends_at" TO "trialEndsAt";
